...
En este ejemplo, se utiliza el nombre de conjunto de registros "@" para crear un registro MX en el vértice de la zona (en este caso, "contoso.com"). Esto es común para los registros MX.
...
Si va a crear un registro SRV en la raíz de una zona, especifique simplemente *_service* y *_protocol* en el nombre de registro. No es necesario incluir "@" en el nombre del registro.
...
### <a name="create-a-txt-record-set-with-a-single-record"></a>Crear un conjunto con un único registro de registros TXT
